        ...
        Plugin = function(element, options, dataName) {
            ...
            //      Constructs the plugin
                create = function(callback) {
                    ...
                    var column_count = this.self.options.dataSource.columns().length;

                    var row = $('<tr>').append($('<td>',{colspan:column_count}).html('no results'));
                    $(this.self.element).children('tbody').html('').append(row);
